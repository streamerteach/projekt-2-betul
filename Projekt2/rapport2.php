<?php 
// 1. Check session and include the header (which handles <html> and <head>)
    ...
    <div class="rapport-content">
        ...
        <section>
            ...
            <p>
                ...
                Det tog en stund att förstå hur man kopplar ihop tabeller för att visa kommentarer.
            </p>
            ...
            <p>
                Jag tycker kursen har varit bra, men fler praktiska exempel på SQL-kopplingar tidigt i kursen hade hjälpt.
            </p>
...
<img src="db_diagram.png" alt="Mitt databasdiagram" style="max-width: 100%; border: 1px solid #ccc;">
        ...
        <hr> <footer style="margin-top: 20px; padding-top: 10px; border-top: 1px solid #eee;">
            
            <p>Inloggning för test: Användarnamn: gulerbet , Lösenord:XEXwq7UaMf </p>
        </footer>
    </div>
</div>
